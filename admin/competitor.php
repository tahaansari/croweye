         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="menu nav navbar-nav navbar-right">
                  <li>
                      <a href="client_view.php">Home</a>
                  </li>
                  
                  <li>
                      <a href="<?php echo $_SERVER['PHP_SELF']; ?>"  class="active" >Competitor's News</a>
                  </li>
               ...
               <a href="export.php"><button class="btn col-md-12 btn-primary">Export Data to Excel</button></a>
                  ...
                  <form id="filterForm">
                       ...
                       <div class="" style="padding: 5px;">
                            <div>
                               <div class="">
                                  <p style="margin-top: 40px;">From</p>
               ...
               <table class="col-md-12 table-bordered table-striped table-condensed cf">
                  ...
                  <tbody id="dynamic_values">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT `t_id`, `t_u_id`,`t_news_type`, `t_pub_date`, `t_title`, `t_journalist`, `t_guest`, `t_pub_name`, `t_pub_edition`, `t_pub_suppliment`, `t_pub_language`, `t_industry`, `t_client_name`, `t_summary` FROM `tbl_transaction` WHERE `t_industry`= '".$_SESSION['c_industry']."' LIMIT 0, 15";

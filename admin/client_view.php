<?php 
   ...
   if(!isset($_SESSION['is_logged_in']) || $_SESSION['login_type'] != 'client'){
   ...
   // $select_query = "SELECT `t_id`, `t_u_id`, `t_pub_date`, `t_title`, `t_journalist`, `t_guest`, `t_pub_name`, `t_pub_edition`, `t_pub_suppliment`, `t_pub_language`, `t_industry`, `t_client_name`, `t_summary` FROM `tbl_transaction`";
...
<html lang="en">
   <head>
      ...
      <link rel='stylesheet' href='../admin/assets/css/photoswipe.css'>
      <link rel='stylesheet' href='../admin/assets/css/default-skin.css'>
      <!--       <link href="css/demo.css" rel="stylesheet">
         <link href="css/normalize.css" rel="stylesheet"> -->
      <link href="../admin/assets/css/component.css" rel="stylesheet">
      <!-- for image gallery end -->
      <link href="../admin/assets/css/cust_style.css" rel="stylesheet">
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="menu nav navbar-nav navbar-right">
                  <li>
                      <a href="<?php echo $_SERVER['PHP_SELF'];?>" class="active" style="color:white">Home</a>
                  </li>
                  
                  <li>
                      <a href="competitor.php">Competitor's News</a>
                  </li>
                  ...
                  <li>
                     <h4 href="#" style="padding: 5px;margin-top: 35px; color:#FF5722;"><?php echo $_SESSION['c_email']; ?></h4>
                  </li>
                  <li>
...
<!--               <p>
               ...
               <div class="panel-body">
                      ...
                      <a href="export.php"><button class="btn col-md-12 btn-primary">Export Data to Excel</button></a>
                      <!-- <button class="btn col-md-6 btn-success">Print</button> -->
                      <!-- <button class="btn col-md-4 btn-warning">Email</button> -->
                  ...
                  <form id="filterForm">
                       ...
                       <div class="" style="padding: 5px;">
                            ...
                            <div>
                               ...
                               <div class="">                        
                                  <p>To</p>
                                  <input name="to" onchange="search_change(this.value)" id="to_datepicker" placeholder="Select Date" class="form-control input-sm">
                               </div>
                            </div>
                            <div >
                               <p >Publication</p>
               ...
               <table class="col-md-12 table-bordered table-striped table-condensed cf">
                  ...
                  <tbody id="dynamic_values">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT `t_id`, `t_u_id`,`t_news_type`, `t_pub_date`, `t_title`, `t_journalist`, `t_guest`, `t_pub_name`, `t_pub_edition`, `t_pub_suppliment`, `t_pub_language`, `t_industry`, `t_client_name`, `t_summary` FROM `tbl_transaction` 
                        WHERE `t_client_name`='".$_SESSION['c_name']."' LIMIT $start, $limit";
                          ...
                          if($num_rows>0){
                              ...
                              while($query2=mysqli_fetch_array($query))
                              {
                                     echo    "<tr>";
                                      ...
                                      // echo    "<td data-title=''><a data-toggle='modal' data-target='#delete_modal' style='color:red' href=''><b>DELETE</b></a></td>";
                                    echo    "</tr>";
      ...
      <script src='../admin/assets/js/photoswipe.min.js'></script>
      <script src='../admin/assets/js/photoswipe-ui-default.min.js'></script>
      <script src='../admin/assets/js/photoswipe-ui-default.min.js'></script>
      <script src="../admin/assets/js/custom-file-input.js"></script>
      <script src="../admin/assets/js/functions.js"></script>
      <script src="../admin/assets/js/cust_script.js"></script>

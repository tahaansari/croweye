               ...
               <ul class="menu nav navbar-nav navbar-right">
                  ...
                  <li>
                     <a id="add_user" style="cursor:pointer">Add User</a>
                        ...
                        <li>
                           <a href="client.php"">Edit Client</a>
                        </li>
               ...
               <table class="col-md-12 table-bordered table-striped table-condensed cf">
                  ...
                  <tbody id="dynamic_values">
                    ...
                    <?php 
                        ...
                        $sql = "SELECT `u_id`,`u_created_date`, `username`, `u_email`,`u_active` FROM `tbl_user` LIMIT $start, $limit";
                        ...
                        if($query=mysqli_query($con,$sql)){
                          ...
                          if($num_rows>0){
                              ...
                              while($query2=mysqli_fetch_array($query))
                              {
                                    ...
                                    $query2['u_active'] == "y" ? $Status="Active" : $Status="Deactive";
                                    $query2['u_active'] == "y" ? $action="DEACTIVATE" : $action="ACTIVATE";


                           echo    "<tr id='tr_".$query2['u_id']."'>";
                            echo    "<td data-title='Publish Date'>".date( "d/m/Y", strtotime($query2['u_created_date']) )."</td>";
                            echo    "<td data-title='Title'>".$query2['username']."</td>";
                            echo    "<td data-title='Title'>".$query2['u_email']."</td>";
                            
                            echo    "<td id='status_".$query2['u_id']."' data-title='Publication'>".$Status."</td>";

                            

                            echo    "<td data-title=''><a id='st_".$query2['u_id']."' onclick='update_user(this.id)'>  <b>".$action."</b></a></td>";

                            echo    "<td data-title=''><a id='del_".$query2['u_id']."' onclick='delete_user(this.id)' style='color:red'><b>DELETE</b></a></td>";
                          echo    "</tr>";
                            ...
                            if($num_rows>14){
                               ...
                               $total=ceil($rows/$limit);
                                ...
                                if($id!=$total)
                                {
                                    echo "<a style='margin: 10px 0px' href='?id=".($id+1)."' class='button'>NEXT</a>";
                                }
                                ...
                                echo "<tr>";
                                echo  "<td colspan='10'>NO USER AVAILABLE</td>";
                                echo "<tr>";
